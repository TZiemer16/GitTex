...
\definecolor[named]{color01}{rgb}{.1,.05,.6} % Color used in the title page
...
\setstocksize{21.59cm}{13.97cm} % USE ME!?
%\setstocksize{19.8cm}
%\setstocksize{27.94cm}{21.59cm}  % 8.5"x11" paper
...
\makeheadrule{mio}{\textwidth}{0.5mm} % Header rule height
...
\makeoddfoot{plain}{}{\footnotesize {\thepage}}{} % Pages of chapters  %%%%%%%%%%%%%%%%%%%% %  \quad \vrule \quad \thelastpage
...
\renewcommand{\beforepartskip}{\null\vskip.5\textheight} % Whitespace above the part heading

%----------------------------------------------------------------------------------------
%	CHAPTER FORMAT
%----------------------------------------------------------------------------------------

\makechapterstyle{CleanBold}{%
...
\renewcommand{\chapterheadstart}{\null \vskip0.5 \onelineskip} % Whitespace before the chapter starts
\renewcommand{\printchaptername}{\large \chaptername} % "Chapter" text font specification
...
\chapterstyle{CleanBold} % Set the chapter style to the custom style defined above
